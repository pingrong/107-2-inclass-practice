...
sampledTranscriptData# sampledTranscriptData
...
```{r}
rr<-str_replace_all(sampledTranscriptData[["系級"]],"1","")
rr<-str_replace_all(rr,"2","")
rr<-str_replace_all(rr,"3","")
sampledTranscriptData$學系<-str_replace_all(rr,"4","")
sampledTranscriptData$學系# sampledTranscriptData$學系 
```
